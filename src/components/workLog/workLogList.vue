  ...
  <div>
    ...
    <div>
      ...
      <div style="padding-top: 15px">
        <a-table v-if="showTable" @change="handleTableChange" :columns="columns" :data-source="data" :rowKey='(record,index)=> index' :loading="loading" size="small" :pagination="pagination" :scroll="{ x: 800 }">
